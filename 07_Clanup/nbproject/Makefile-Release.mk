...
${OBJECTDIR}/AdminController.o: AdminController.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AdminController.o AdminController.cpp

${OBJECTDIR}/AdminView.o: AdminView.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AdminView.o AdminView.cpp
...
${OBJECTDIR}/Generics.o: Generics.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Generics.o Generics.cpp
...
${OBJECTDIR}/UsrAccntController.o: UsrAccntController.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UsrAccntController.o UsrAccntController.cpp

${OBJECTDIR}/UsrAccntView.o: UsrAccntView.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UsrAccntView.o UsrAccntView.cpp

${OBJECTDIR}/UsrAccntsModel.o: UsrAccntsModel.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UsrAccntsModel.o UsrAccntsModel.cpp
